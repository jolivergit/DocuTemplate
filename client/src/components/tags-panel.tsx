      ...
      <div className="flex items-start gap-3">
        <div className="flex-shrink-0 mt-0.5">
          {isMapped ? (
            ...
            <Circle className="w-5 h-5 text-muted-foreground" data-testid={`icon-unmapped-${tagName}`} />
          )}
        </div>
        
        <div className="flex-1 min-w-0">
          <code className="text-sm font-mono block mb-1" data-testid={`text-tag-name-${tagName}`}>
            &lt;&lt;{tagName}&gt;&gt;
          </code>
